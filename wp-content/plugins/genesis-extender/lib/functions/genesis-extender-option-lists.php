...
function genesis_extender_css_elements_array()
{
	$genesis_extender_css_elements_array = array(
		...
		'-- Containers --' => array(
			'Main Wrap' => '/* Main Wrap */' . "\n" . genesis_extender_html_markup( 'site_container' ),
			'Inner Wrap' => '/* Inner Wrap */' . "\n" . genesis_extender_html_markup( 'site_inner' ),
			'Content Sidebar Wrap' => '/* Content Sidebar Wrap */' . "\n" . genesis_extender_html_markup( 'content_sidebar_wrap' )
		),
		'-- Main Content --' => array(
			...
			'Content Post H1' => '/* Content Post H1 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h1',
			'Content Post H2' => '/* Content Post H2 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h2',
			'Content Post H3' => '/* Content Post H3 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h3',
			'Content Post H4' => '/* Content Post H4 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h4',
			'Content Post H5' => '/* Content Post H5 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h5',
			'Content Post H6' => '/* Content Post H6 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post h6',
			'Content Page H1' => '/* Content Page H1 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h1',
			'Content Page H2' => '/* Content Page H2 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h2',
			'Content Page H3' => '/* Content Page H3 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h3',
			'Content Page H4' => '/* Content Page H4 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h4',
			'Content Page H5' => '/* Content Page H5 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h5',
			'Content Page H6' => '/* Content Page H6 */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page h6',
		...
		'-- Author Box --' => array(
			...
			'Author Box Title' => '/* Author Box Title */' . "\n" . genesis_extender_html_markup( 'author_box_title' ),
			'Author Box Paragraph' => '/* Author Box Paragraph */' . "\n" . genesis_extender_html_markup( 'author_box_content' ),
		...
		'-- Primary Sidebar --' => array(
			...
			'Primary Sidebar H4' => '/* Primary Sidebar H4 */' . "\n" . genesis_extender_html_markup( 'sidebar_primary' ) . ' h4',
		...
		'-- Secondary Sidebar --' => array(
			...
			'Secondary Sidebar UL/OL' => '/* Secondary Sidebar UL/OL */' . "\n" . genesis_extender_html_markup( 'sidebar_secondary' ) . ' ul, ' . genesis_extender_html_markup( 'sidebar_secondary' ) . ' ol',
			'Secondary Sidebar UL LI' => '/* Secondary Sidebar UL LI */' . "\n" . genesis_extender_html_markup( 'sidebar_secondary' ) . ' ul li'
		),
		'-- Comments --' => array(
			'Comments' => '/* Comments */' . "\n" . '#comments',
 ...
 */
function genesis_extender_primary_navigation_elements_array()
{
	$genesis_extender_primary_navigation_elements_array = array(
		'-- Primary Navigation --' => array(
			'Primary Nav' => '/* Primary Nav */' . "\n" . genesis_extender_html_markup( 'nav_primary' ),
			'Primary Nav Menu' => '/* Primary Nav Menu */' . "\n" . '.menu-primary',
			'Primary Nav Page Link' => '/* Primary Nav Page Link */' . "\n" . '.menu-primary a',
	...
	return $genesis_extender_primary_navigation_elements_array;
}
 ...
 */
function genesis_extender_secondary_navigation_elements_array()
{
	$genesis_extender_secondary_navigation_elements_array = array(
		'-- Secondary Navigation --' => array(
			'Secondary Nav' => '/* Secondary Nav */' . "\n" . genesis_extender_html_markup( 'nav_secondary' ),
			'Secondary Nav Menu' => '/* Secondary Nav Menu */' . "\n" . '.menu-secondary',
			'Secondary Nav Page Link' => '/* Secondary Nav Page Link */' . "\n" . '.menu-secondary a',
	...
	return $genesis_extender_secondary_navigation_elements_array;
}
 ...
 */
function genesis_extender_main_content_elements_array()
{
	$genesis_extender_main_content_elements_array = array(
		'-- Main Content --' => array(
			'Content' => '/* Content */' . "\n" . genesis_extender_html_markup( 'content' ),
			'Content Post' => '/* Content Post */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .post',
			'Content Page' => '/* Content Page */' . "\n" . genesis_extender_html_markup( 'content' ) . ' .page',
	...
	return $genesis_extender_main_content_elements_array;
}
 ...
 */
function genesis_extender_breadcrumbs_elements_array()
{
	$genesis_extender_breadcrumbs_elements_array = array(
		'-- Breadcrumbs --' => array(
			'Breadcrumbs' => '/* Breadcrumbs */' . "\n" . '.breadcrumb',
			'Breadcrumbs Link' => '/* Breadcrumbs Link */' . "\n" . '.breadcrumb a',
			'Breadcrumbs Link Hover' => '/* Breadcrumbs Link Hover */' . "\n" . '.breadcrumb a:hover'
	...
	return $genesis_extender_breadcrumbs_elements_array;
}
 ...
 */
function genesis_extender_sidebars_elements_array()
{
	$genesis_extender_sidebars_elements_array = array(
	...
	return $genesis_extender_sidebars_elements_array;
}
 ...
 */
function genesis_extender_primary_sidebar_elements_array()
{
	$genesis_extender_primary_sidebar_elements_array = array(
		'-- Primary Sidebar --' => array(
			'Primary Sidebar' => '/* Primary Sidebar */' . "\n" . genesis_extender_html_markup( 'sidebar_primary' ),
			'Primary Sidebar H4' => '/* Primary Sidebar H4 */' . "\n" . genesis_extender_html_markup( 'sidebar_primary' ) . ' h4',
			'Primary Sidebar Widget' => '/* Primary Sidebar Widget */' . "\n" . genesis_extender_html_markup( 'sidebar_primary' ) . ' .widget',
	...
	return $genesis_extender_primary_sidebar_elements_array;
}
 ...
 */
function genesis_extender_secondary_sidebar_elements_array()
{
	$genesis_extender_secondary_sidebar_elements_array = array(
		'-- Secondary Sidebar --' => array(
			'Secondary Sidebar' => '/* Secondary Sidebar */' . "\n" . genesis_extender_html_markup( 'sidebar_secondary' ),
			'Secondary Sidebar H4' => '/* Secondary Sidebar H4 */' . "\n" . genesis_extender_html_markup( 'sidebar_secondary' ) . ' h4',
			'Secondary Sidebar Widget' => '/* Secondary Sidebar Widget */' . "\n" . genesis_extender_html_markup( 'sidebar_secondary' ) . ' .widget',
	...
	return $genesis_extender_secondary_sidebar_elements_array;
}
 ...
 */
function genesis_extender_comments_respond_elements_array()
{
	$genesis_extender_comments_respond_elements_array = array(
		'-- Comments Respond --' => array(
			'Comments Respond' => '/* Comments Respond */' . "\n" . '#respond',
			'Reply Title' => '/* Reply Title */' . "\n" . '#respond h3',
			'Author/Email/URL/Comment' => '/* Author/Email/URL/Comment */' . "\n" . '#author, #comment, #email, #url',
	...
	return $genesis_extender_comments_respond_elements_array;
}
 ...
 */
function genesis_extender_genesis_footer_widgets_elements_array()
{
	$genesis_extender_genesis_footer_widgets_elements_array = array(
		'-- Genesis Footer Widgets --' => array(
			'Footer Widgets Container' => '/* Genesis Footer Widgets Container */' . "\n" . '.footer-widgets',
			'Footer Widgets Inner Wrap' => '/* Genesis Footer Widgets Inner Wrap */' . "\n" . '.footer-widgets .wrap',
			'Footer Widgets Widget' => '/* Genesis Footer Widgets Widget */' . "\n" . '.footer-widgets .widget',
	...
	return $genesis_extender_genesis_footer_widgets_elements_array;
}
 ...
 */
function genesis_extender_images_alignment_elements_array()
{
	$genesis_extender_images_alignment_elements_array = array(
		'-- Images / Alignment --' => array(
			'Image Align None' => '/* Image Align None */' . "\n" . 'img.alignnone',
			'Image Align Left' => '/* Image Align Left */' . "\n" . 'img.alignleft',
			'Image Align Center' => '/* Image Align Center */' . "\n" . 'img.centered',
	...
	return $genesis_extender_images_alignment_elements_array;
}
