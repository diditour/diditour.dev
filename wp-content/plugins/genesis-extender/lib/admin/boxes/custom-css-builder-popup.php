			...
			<div id="genesis-extender-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="custom-css-builder-nav-open-close-elements-box" class="genesis-extender-all-css-builder genesis-extender-options-display">
					<p style="float:left;">
						...
						<input class="custom-css-builder-button-elements custom-css-builder-buttons" style="width:30px;" type="button" value="&raquo;" onclick="insertAtCaret(this.form.text, this.form.custom_css_divs.value+'\n\n}\n')"><br />
						...
						<span id="body-label-select" class="all-labeled-elements">
							...
							<input class="custom-css-builder-button-elements custom-css-builder-buttons labeled-elements-button" style="width:30px;" type="button" value="&raquo;" onclick="insertAtCaret(this.form.text, this.form.body_elements_list.value+'\n\n}\n')">
						</span>
