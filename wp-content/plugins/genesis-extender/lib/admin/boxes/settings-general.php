			...
			<div class="genesis-extender-optionbox-inner-2col">
				...
				<div class="bg-box">	
					<p>
						...
						<span id="show-add-google-fonts" class="genesis-extender-options-reset-button button" style="float:none !important;">Google Fonts</span><a href="http://extenderdocs.cobaltapps.com/article/106-add-google-fonts" class="tooltip-mark" target="_blank">[?]</a>
